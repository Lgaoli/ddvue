...
{name:'云南', cityList:[
        ...
        {name:'普洱市', areaList:['翠云区','普洱哈尼族彝族自治县','墨江哈尼族自治县','景东彝族自治县','景谷傣族彝族自治县','镇沅彝族哈尼族拉祜族自治县','江城哈尼族彝族自治县','孟连傣族拉祜族佤族自治县','澜沧拉祜族自治县','西盟佤族自治县']},
...
{name:'河南', cityList:[
        ...
        {name:'洛阳市', areaList:['老城区','西工区','瀍河回族区','涧西区','吉利区','洛龙区','孟津县','新安县','栾川县','嵩　县','汝阳县','宜阳县','洛宁县','伊川县','偃师市']},
...
{name:'黑龙江', cityList:[
        {name:'哈尔滨市', areaList:['道里区','南岗区','道外区','香坊区','平房区','松北区','呼兰区','依兰县','方正县','宾　县','巴彦县','木兰县','通河县','延寿县','阿城市','双城市','尚志市','五常市']},
        ...
        {name:'佳木斯市', areaList:['向阳区','前进区','东风区','郊　区','桦南县','桦川县','汤原县','抚远县','同江市','富锦市']},
        ...
        {name:'大兴安岭地区', areaList:['呼玛县','塔河县','漠河县','加格达奇区','松岭区','新林区','呼中区']}
    ]},
{name:'海南', cityList:[
        {name:'海口市', areaList:['秀英区','龙华区','琼山区','美兰区']},
        {name:'三亚市', areaList:['崖州区','天涯区','吉阳区','海棠区']},
        {name:'三沙市',areaList:['三沙市']},
        {name:'儋州市',areaList:['儋州市']},
        {name:'洋浦经济开发区',areaList:['洋浦经济开发区']},
        {name:'省直辖县', areaList:['五指山市','琼海市','文昌市','万宁市','东方市','定安县','屯昌县','澄迈县','临高县','白沙黎族自治县','昌江黎族自治县','乐东黎族自治县','陵水黎族自治县','保亭黎族苗族自治县','琼中黎族苗族自治县']}
    ]},
{name: '台湾省', cityList: [
        {name:'台北市', areaList:['内湖区','南港区','中正区','万华区','大同区','中山区','松山区','大安区','信义区','文山区','士林区','北投区']
        },
        {name: '新北市', areaList:['板桥区','汐止区','新店区']
        },
...
{name: '澳门', cityList: [
        {name: '澳门', areaList:['花地玛堂区','圣安多尼堂区','大堂区','望德堂区','风顺堂区','嘉模堂区','圣方济各堂区','路凼']
        }
    ]},
{name: '香港',cityList: [
        {name: '香港', areaList:['深水埗区','油尖旺区','九龙城区','黄大仙区','观塘区','北区','大埔区','沙田区','西贡区','元朗区','屯门区','荃湾区','葵青区','离岛区','中西区','湾仔区','东区','南区']
        }
    ]}
